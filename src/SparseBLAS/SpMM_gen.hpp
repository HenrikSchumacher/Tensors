public:
    ...
    {
        // This is basically a large switch to determine at runtime, which instantiation of SpMM_gen_implementation is to be invoked.
        // In particular, this implies that all relevant cases of SpMM_gen_implementation are instantiated.
