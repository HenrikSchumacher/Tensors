...
namespace Tensors
{
    namespace Sparse
    {
        ...
        class CLASS : public Sparse::PatternCSR<Int_,LInt_>
        {
        private:
...
#pragma omp parallel for num_threads( thread_count )
            ...
            BinaryMatrixCSR<Int,LInt> DotBinary( const CLASS & B ) const
            {
        ...
        public:
            ...
            {
                return "Sparse::"+TO_STD_STRING(CLASS)+"<"+TypeName<Scalar>::Get()+","+TypeName<Int>::Get()+","+TypeName<LInt>::Get()+">";
            }
