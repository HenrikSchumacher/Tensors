...
void Read_N( cptr<A_T> A, const Int ldA )
{
    ...
    ptic(ClassName()+"::Read_N_with_pointers<" + TypeName<A_T> + ">");
...
//                            );
    ...
    ptoc(ClassName()+"::Read_N_with_pointers<" + TypeName<A_T> + ">");
}
...
void Read_T( cptr<A_T> A, const Int ldA )
{
    ...
    ptic(ClassName()+"::Read_T_with_pointers<" + TypeName<A_T> + ">");
...
//                            );
    ...
    ptoc(ClassName()+"::Read_T_with_pointers<" + TypeName<A_T> + ">");
}
