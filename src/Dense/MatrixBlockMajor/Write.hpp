...
{
    TOOLS_PTIC(ClassName()+"::Write_N<" + TypeName<alpha_T> + "," + TypeName<beta_T> + "," + TypeName<C_T> + ">");
    ...
    TOOLS_PTOC(ClassName()+"::Write_N<" + TypeName<alpha_T> + "," + TypeName<beta_T> + "," + TypeName<C_T> + ">");
}
...
{
    TOOLS_PTIC(ClassName()+"::Write_T<" + TypeName<alpha_T> + "," + TypeName<beta_T> + "," + TypeName<C_T> + ">");
    ...
    TOOLS_PTOC(ClassName()+"::Write_T<" + TypeName<alpha_T> + "," + TypeName<beta_T> + "," + TypeName<C_T> + ">");
}
